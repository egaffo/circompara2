...
try:
    ...
    print 'linear_quantexp.scons: cannot import', ne, '. Assume command line script call.'
...
#        
#        cuffquant = SConscript(os.path.join(cuffquant_dir, 'cuffquant.py'),
...
#        
#        cuffnorm = SConscript(os.path.join(cuffdiff_dir, 'cuffnorm.py'),
#                              src_dir = env['SCONSCRIPT_HOME'],
