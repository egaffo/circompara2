...
try:
    ...
    print 'build_indexes.scons: command line execution.'
...
if 'HISAT2' in env['INDEXES'].split(','):
    ...
    index = SConscript(os.path.join(index_dir, 'index_hisat2.py'), 
...
if 'SEGEMEHL' in env['INDEXES'].split(','):
    ...
    index = SConscript(os.path.join(index_dir, 'index_segemehl.py'), 
                            src_dir = SCONSCRIPT_HOME, 
                            variant_dir = index_dir, duplicate = 0,
...
if 'BWA' in env['INDEXES'].split(','):
    ...
    index = SConscript(os.path.join(index_dir, 'index_bwa.py'), 
                            src_dir = SCONSCRIPT_HOME, 
                            variant_dir = index_dir, duplicate = 0,
...
if 'BOWTIE2' in env['INDEXES'].split(','):
    ...
    index = SConscript(os.path.join(index_dir, 'index_bowtie2.py'), 
                            src_dir = SCONSCRIPT_HOME, 
                            variant_dir = index_dir, duplicate = 0,
...
if 'BOWTIE' in env['INDEXES'].split(','):
    ...
    index = SConscript(os.path.join(index_dir, 'index_bowtie.py'), 
                            src_dir = SCONSCRIPT_HOME, 
                            variant_dir = index_dir, duplicate = 0,
...
if 'STAR' in env['INDEXES'].split(','):
    ...
    index = SConscript(os.path.join(index_dir, 'index_star.py'), 
                            src_dir = SCONSCRIPT_HOME, 
                            variant_dir = index_dir, duplicate = 0,
